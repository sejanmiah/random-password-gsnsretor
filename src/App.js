...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
      ...
      if (passwordLength < 5) {
        notify("The password you have chosen is too short or too small. Please choose a password that meets the minimum length 5 requirements for security purposes.", true)
        return
      } else {
      let characterList = ""
      if (includeNumbers) {
